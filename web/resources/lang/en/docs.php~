...
return [
	...
	*/
	...
	"Description17" => "Our generator supports some basic filters you can use on values.",
	"Description18" => "The syntax is ",
	"Description19" => "If you use as a parameter string value, you have to enclose it in *value*. For example ",
	"Description20" => "You can also use variables from your temlate data. For example if you have variable named format ",
